    ...
    <form id="form1" runat="server">
        <div class="auto-style1" style="background-image: url('image/82847.jpg')">
            ...
            <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="Welcome..."></asp:Label>
             <br />
            <br />
            <img class="img p" src="O.png" alt="Avatar" style="width:350px">
             <br />
            <br />
            <br />
            <br />
            ...
            <br />
            <span class="auto-style4">Mirazul_Islam</span><br />
             <asp:Button ID="Button1" runat="server" Text="Send_Message" OnClick="Button1_Click" />
             <br />
             <br />
             <br />
            <img class="img p" src="A.png" alt="Avatar" style="width:100px">
            <br />
            <span class="auto-style4">Atik_Shahariar</span><br />
